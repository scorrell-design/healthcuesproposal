...
const DEFAULT_BENEFITS: BenefitsConfig = {
  enabled: false,
  healthcare: { enabled: true, participationRate: 75, medical: { premiums: { individual: 200, family: 775 } }, dental: { premiums: { individual: 35, family: 85 } }, vision: { premiums: { individual: 15, family: 40 } } },
